...
if (!empty($id)) {
   ...
   $sqlFuncionario = "SELECT * FROM clientes WHERE cliente_id = '$id'";
      ...
      <div class="page-header">
         <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
               <h5 class="text-uppercase mb-0 mt-0 page-title">Editar Cliente</h5>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
               <ul class="breadcrumb float-right p-0 mb-0">
                  <li class="breadcrumb-item"><a href="./"><i class="fas fa-home"></i> Home</a></li>
                  <li class="breadcrumb-item"><a href="./?p=10">Cliente</a></li>
                  <li class="breadcrumb-item"><span> Editar Cliente</span></li>
               </ul>
            </div>
         </div>
      </div>
      <div class="page-content">
         <form method="POST" action="./pages/processar/proc_editar_cli.php?id=<?php echo $id; ?>">
                     ...
                     <div class="card-body">
                        <div class="row">
                           <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                              ...
                              <div class="form-group">
                                 <label>Email</label>
                                 <input type="text" class="form-control" name="email" value="<?php echo $rowFuncionario['email']; ?>"readonly>
                              </div>
                              <div class="form-group">
                                 <label>Género</label>
                              ...
                              <div class="form-group">
                                 ...
                                 <input class="form-control datetimepicker-input datetimepicker" type="date" name="data_nasc" data-toggle="datetimepicker" value="<?php echo $rowFuncionario['data_nascimento']; ?>">
                              </div>
                           ...
                           <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                              ...
                              <div class="form-group">
                                 <label>NIF</label>
                                 <input type="text" class="form-control" name="nif" value="<?php echo $rowFuncionario['nif']; ?>">
                              </div>
