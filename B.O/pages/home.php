...
$sqlAgendamentosPR = "SELECT COUNT(*) AS total_agendamentos FROM agendamentos WHERE status = 'por realizar'";
$resultAgendamentosPR = $conn->query($sqlAgendamentosPR);
$rowAgendamentosPR = $resultAgendamentosPR->fetch_assoc();
$totalAgendamentosPR = $rowAgendamentosPR['total_agendamentos'];


$sqlAgendamentosR = "SELECT COUNT(*) AS total_agendamentos FROM agendamentos WHERE status = 'realizado'";
$resultAgendamentosR = $conn->query($sqlAgendamentosR);
$rowAgendamentosR = $resultAgendamentosR->fetch_assoc();
$totalAgendamentosR = $rowAgendamentosR['total_agendamentos'];
  ...
  <div class="content container-fluid">
      ...
      <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
        <div class="dash-widget dash-widget5">
          ...
          <div class="dash-widget-info text-right">
            ...
            <h3><?php echo $totalAgendamentosPR; ?></h3>
          </div>
        </div>
      </div>
      <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
      ...
      <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
        <div class="dash-widget dash-widget5">
          <div class="dash-widget-info d-inline-block text-left">
            ...
            <h3><?php echo ($totalAgendamentosR > 0) ? $totalAgendamentosR : 0; ?></h3>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Validar Agendamento</h4>
          </div>
          <div class="card-body">
            <div class="table-responsive">
            <h5>*Inseri o código fornecido pelo cliente*</h5>
            <br>
              <form method="POST">
                <table class="table m-b-0">
                  <tbody>
                    <tr>
                      <td>
                        <input type="text" placeholder="agendamento" class="form-control" style="width: 150px; height: 49px; text-align: center; margin: 0 auto;">
                      </td>
                    </tr>
                  </tbody>
                </table>
                <div class="m-t-20 text-center">
                  <button class="btn btn-primary btn-lg" type="submit">Validar Código</button>
                </div>
              </form>
      ...
      <div class="col-lg-12">
        <div class="card flex-fill">
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col-auto">
                <div class="page-title">Novos Agendamentos</div>
              </div>
            </div>
          </div>
          <div class="card-body">
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td><a href="#" class="__cf_email__" data-cfemail="5a373339323b3f362c382f2e2e3b28291a3f223b372a363f74393537">
                            <?php echo $email; ?>
                          </a></td>
                        <td>
