...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04-Jul-2023 às 01:12
...
INSERT INTO `agendamentos` (`id`, `data`, `hora`, `id_cliente`, `id_funcionario`, `servicos`, `preco_total`, `status`, `cancelar`, `razao_cancelar`, `start_time`, `end_time_expected`) VALUES
(4, '2023-04-27', '00:00:00', 1, 3, '', '23.00', 'agendado', 0, NULL, '2023-05-15 18:23:35', NULL),
(5, '2023-07-04', '16:45:00', 1, 3, '16.00', '0.00', 'agendado', 0, NULL, '2023-07-03 06:50:55', NULL);
...
INSERT INTO `clientes` (`cliente_id`, `primeiro_nome`, `ultimo_nome`, `username`, `password`, `nif`, `telefone`, `email`, `data_nascimento`, `data_cadastro`, `code`, `data_code`, `estado_id`) VALUES
(1, '', '', '', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 3024956, '923834524', 'gab@gmail.com', '2003-02-12', '2023-04-04 23:00:00', 0, NULL, 3),
...
(7, 'Guci', 'vani', '', '$2y$10$csndKPQiSMovH8czrGeBTula6abeXJibC', 0, '', 'gucivanimufuma@gmail.com', '0000-00-00', '2023-06-30 20:52:17', 0, NULL, 3),
