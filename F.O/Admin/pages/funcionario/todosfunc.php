        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-12 text-right add-btn-col">
                    <a href="./?p=6" class="btn btn-primary btn-rounded float-right"><i class="fas fa-plus"></i> Add funcionario</a>
                    <div class="view-icons">
                        <a href="#" class="grid-view btn btn-link active"><i class="fas fa-th"></i></a>
                        <a href="./?p=7" class="list-view btn btn-link"><i class="fas fa-bars"></i></a>
                    </div>
                </div>
            </div>
                ...
                ?>
                        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                            <div class="profile-widget">
                                ...
                                <div class="small text-muted"><?php echo $habilidades; ?></div>
                            </div>
                        </div>
                <?php
                    }
