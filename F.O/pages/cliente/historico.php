                    ...
                    <div class="table_page table-responsive">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<td class="product_remove"><a href="./pages/processos/apagar_agendamentos.php?id=' . $row['id'] . '"><i class="fa fa-trash-o"></i></a></td>';
                            }
                            echo '</tbody>';
                            echo '</table>';
                            echo '<div class="cart_submit">';
                            echo '<form action="./pages/processos/apagar_agendamentos.php" method="post">';
