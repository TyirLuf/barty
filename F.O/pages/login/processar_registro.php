    ...
    if (empty($dados['ult_nome'])) {
        ...
        if ($result_usuario->num_rows != 0) {
            ...
            if ($dados['pass'] !== $dados['confir_pass']) {
               ...
               $verification_code Seu código de vereficação</a><br><br>Esta mensagem foi enviada a você pela empresa XXX.<br>Você está recebendo porque está cadastrado no banco de dados da empresa XXX. Nenhum e-mail enviado pela empresa XXX tem arquivos anexados ou solicita o preenchimento de senhas e informações cadastrais.<br><br>";
