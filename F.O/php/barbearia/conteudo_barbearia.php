<section class="gap-to-menu barbearia">
    ...
    <div class='container'>
        ...
        // Serviços
        if($rowServicos > 0){
            while($funcionarios = $resultfuncionarios->fetch_assoc()){
                echo "
                    <div class='input-container'>
                        <input 
                            id='{$funcionarios["func_id"]}' 
                            type='checkbox' 
                            value='{$funcionarios["primeiro_nome"]}'
                            value='{$funcionarios["ultimoo_nome"]}'
                            name='servico-{$funcionarios["func_id"]}'
                            data-target-title='btn-servico'
                            onChange='handleCheck(this);'
                        >
                        <label for='{$funcionarios["id_servico"]}'>
                            <span>
                                {$funcionarios["primeiro_nome"]} {$funcionarios["ultimo_nome"]}
                                <br>
            ...
            echo "
                <h5 class='sb-txt-white sb-w-500'>
                    Não há Barbeiro disponiveis no estabelecimento                              
                </h5>
            ";
        }
